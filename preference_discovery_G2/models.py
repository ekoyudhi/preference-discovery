...
class Player(BasePlayer):
    ...
    s5 = models.IntegerField(choices=[[1,'Biologi'],[2,'Farmasi'],[3,'Geografi'],[4,'Kedokteran Gigi'],[5,'Medis, Dental, Keperawatan'],[6,'Kehutanan'],[7,'Matetamtika dan Ilmu Alam'],[8,'Pertanian dan Peternakan'],[9,'Teknik dan Rekayasa'],[10,'Teknologi Pertanian'],[11,'Ekonomika dan Bisnis'],[12,'Filsafat'],[13,'Ilmu Budaya dan Agama'],[14,'Studi Sosial, Politik, dan Hukum'],[15,'Psikologi'],[16,'Kesehatan Masyarakat']], label='5) Bidang studi')
    ...
    round_selected = models.IntegerField(Initial=0, blank=False)
